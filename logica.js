...
while (x == 1) {
  ...
  let meses = parseInt(
    prompt("Ingrese la cantidad de meses en los que desea pagar el prestamo: ")
  );

  let pago_mensual =
    (interes_mensual * monto_prestamo) / (1 - (1 + interes_mensual) ** -meses);
  ...
  x = parseInt(
    prompt("Ingrese 1 si quieres volver a realizar otra analisis de prestamo: ")
  );
}
